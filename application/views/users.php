<div class="user-dashboard">
    <div class="user-content">
        ...
        <button type="button" class="btn-blue" onclick="showCollectorForm()">Add Collector</button>
        ...
        <div class="user-table">
            <h3>Collector</h3>
            <form action="" method="POST">
                <input type="text" name="search_employee" placeholder="Search employee">
            </form>
            <table>
                <thead>
                    <th>ID</th>
